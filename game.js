...
//word array
const question = [
  "The Chosen Category Is Cryptocurrency",
  "The Chosen Category Is Finance",
  "The Chosen Category Is Fintech Companies"
];
...
const categories = [
  ...
  ["capital", "accruals", "liquidity", "asset", "depreciation"],
  ["revolut", "paypal", "klarna", "stripe", "chime"]
];

const hints = [
  [
    "Which cryptocurrency has the largest market cap",
    "Was a crowdfunded project",
    "Has The Fastest TPS Of All Major Blockchains",
    "MATIC",
    "Launched in 2012",
    "This token is named after the world's first computer programmer",
    "Stablecoin"
  ],
  [
    "Wealth of a business as demonstrated by its cash accounts, assets, and investments",
    "Expenses that have been incurred but havent yet been recorded in the business books",
    "An indicator of how quickly an asset can be turned into cash",
    "Cash on hand, buildings, equipment, inventory",
    "The asset loses some of its value"
  ],
  [
    ...
    "The company launched publicly on April 15, 2014"
  ]
];
...
function init() {
  ...
  livesDisplay.innerHTML = `Your score is ${life} `;
  setAnswer();
...
function guess(event) {
  ...
  if (answer === winningCheck) {
    ...
    //console.log(life);
    if (answer === winningCheck) {
      livesDisplay.innerHTML = `YOU WIN!, YOUR SCORE IS ${life}!`;
      return;
    }
  }
}
